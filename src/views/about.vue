...
<template>
  <div class="text-center flex flex-col justify-center items-center p-4">
    ...
    >
      Face Attendance System (FAS for short) is a face recognition software that
      saves your face to storage in Registration mode and then compares it to
      other saved faces in attendance mode. Each successful attendance mode
      session adds an entry to the attendances sheet table

      <i class="mt-4">Your data doesn't leave Your System !!!</i>
    </div>
  </div>
</template>
